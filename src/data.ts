export const chars = [
  ...
  },
  {
    ...
    actions: [
      ...
      { type: 'attack', pic: 'sword', background: 'bg-rose-400', name: '射击', desc: '造成伤害' },
      { type: 'attack', pic: 'sword', background: 'bg-rose-400', name: '精准射击', value: 9, desc: '造成9点伤害' },
      { type: 'attack', pic: 'sword', background: 'bg-rose-400', name: '精准射击', value: 9, desc: '造成9点伤害' },
  ...
  },
  {
    ...
    actions: [
      ...
      { type: 'attack', pic: 'sword', background: 'bg-rose-400', name: '精准飞弹', value: 9, desc: '造成9点伤害' },
  ...
  },
  {
    ...
    actions: [
      ...
      { type: 'attack', pic: 'sword', background: 'bg-rose-400', name: '精准圣光', value: 3, desc: '造成3点伤害' },
      { type: 'heart', pic: 'hearts', background: 'bg-amber-400', name: '精准治疗', value: 3, desc: '恢复3点生命' },
      { type: 'heart', pic: 'hearts', background: 'bg-amber-400', name: '精准治疗', value: 3, desc: '恢复3点生命' },
  ...
  },
  {
    ...
    background: 'bg-gradient-to-br from-rose-500 to-amber-500',
    actions: [
      { type: 'attack', pic: 'sword', background: 'bg-rose-400', name: '精准小刀突刺', value: 2, desc: '造成2点伤害' },
      { type: 'heart', pic: 'hearts', background: 'bg-amber-400', name: '医治', desc: '恢复生命' },
      { type: 'heart', pic: 'hearts', background: 'bg-amber-400', name: '精准医治', value: 3, desc: '恢复4点生命' },
  ...
  },
  {
    ...
    actions: [
      ...
      { type: 'attack', pic: 'sword', background: 'bg-rose-400', name: '精准树根缠绕', value: 9, desc: '造成伤害' },
      { type: 'heart', pic: 'hearts', background: 'bg-amber-400', name: '再生', desc: '恢复生命' },
      { type: 'heart', pic: 'hearts', background: 'bg-amber-400', name: '精准再生', value: 9, desc: '恢复生命' },
      { type: 'empty', background: 'bg-gray-400', name: '施法失败' },
      { type: 'empty', background: 'bg-gray-400', name: '施法失败' },
    ]
  }
