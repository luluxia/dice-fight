    ...
    steps: [
      {
        ...
        popover: {
          title: '欢迎来到《骰子大作战》',
          description: `
          <p>骰子大作战是一个使用骰子来进行战斗的游戏。</p>
          <p>双方将各自携带3枚点数骰子与角色骰子来进行对决。</p>
          <p>首先请点击投掷按钮，投掷骰子吧。</p>
          `,
          side: 'top',
        },
      },
      {
        ...
        popover: {
          ...
          <p>而角色骰子的六个面，则代表了不同的角色行动，例如攻击、护盾、恢复…。</p>
          <p>角色骰子的灰色面，则代表行动落空，无法被使用。</p>
          <p>长按角色骰子，可以查看行动的详细说明。</p>
          <p>确认完毕后，就点击下一步吧。</p>
          `,
        },
        onHighlightStarted() {
      ...
      },
      {
        ...
        popover: {
          title: '发动行动',
          description: `
          <p>当行动栏中只放置了一枚角色骰子时，可以消耗骰子发动其对应的行动。</p>
      ...
      },
      {
        ...
        popover: {
          title: '选取角色骰子',
          description: `
          <p>对手只剩下3点生命了，而此时我们正好还剩下一枚可以造成6点固定伤害的角色骰子。</p>
          <p>选取骰子，一鼓作气战胜对手吧。</p>
          `
        },
        onHighlightStarted() {
